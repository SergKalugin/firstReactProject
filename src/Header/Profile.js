            ...
            <div class="mad-profile__dropdown">
              ...
              <div class="mad-profile__dropdown-element" aria-hidden="true">
                <ul class="mad-profile__list with-icons">
                  <li><a href="stream.html"><i class="material-icons-outlined">home</i>Stream</a></li>
                  <li><a href="about.html"><i class="material-icons-outlined">account_circle</i>About</a></li>
                  <li><a href="blog.html"><i class="material-icons-outlined">library_books</i>Blog</a></li>
                  <li><a href="classifieds.html"><i class="material-icons-outlined">ballot</i>Classifieds</a></li>
                  <li><a href="friends.html"><i class="material-icons-outlined">group</i>Friends</a></li>
                  <li><a href="group.html"><i class="material-icons-outlined">group_work</i>Groups</a></li>
                  <li><a href="photos.html"><i class="material-icons-outlined">photo_library</i>Photos</a></li>
